#ifndef VIS4EARTH_IO_VOL_OSG_IO_H
#define VIS4EARTH_IO_VOL_OSG_IO_H
...
class RAWVolume {
  public:
    ...
    NormalizedFloatToTexture(const std::vector<float> &dat, const std::array<uint32_t, 3> &srcDim,
...
#endif // !VIS4EARTH_IO_VOL_OSG_IO_H
