#ifndef VIS4EARTH_IO_TF_IO_H
#define VIS4EARTH_IO_TF_IO_H
...
class TransferFunctionPoints {
  public:
    static std::vector<std::pair<uint8_t, std::array<float, 4>>>
    LoadFromFile(const std::string &filePath, std::string *errMsg = nullptr) {
    ...
    static bool DumpToFile(const std::string &filePath,
