...
#include <vis4earth/info_viser/curve_chart.h>
...
int main(int argc, char **argv) {
    ...
    std::shared_ptr<VIS4Earth::InfoViser::CurveChart> mcb =
        std::make_shared<VIS4Earth::InfoViser::CurveChart>();
    std::string errMsg;
    clock_t prevClk;
    {
        ...
        grp->addChild(vol0->MakeCurveChart());
        ...
        grp->addChild(vol1->MakeCurveChart(osg::Vec4f(0.6, 0.3, 0.5, 1.0)));
        ...
        grp->addChild(vol2->MakeCurveChart(osg::Vec4f(0.3, 0.6, 0.5, 1.0)));
        ...
        grp->addChild(vol3->MakeCurveChart(osg::Vec4f(0.3, 0.4, 0.7, 1.0)));
    }
